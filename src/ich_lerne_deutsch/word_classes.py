...
class Verb:
    def __init__(self,infinitive_form,definition,partizip_2=None,perfekt_hilfsverb=None):
...
class Noun:
    def __init__(self,root_form,gender,plural_form=None,plural_dative_form = None,genitive_form=None,definition = '',only_plural=False):
        self._root_form = root_form
    ...
    def number(self,value):
        ...
        if self._plural_form is None:
            value = 'SIN'
        if self._only_plural:
            value = 'PLU'
        self._number = value
